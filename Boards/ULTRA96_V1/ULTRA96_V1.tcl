...
proc avnet_add_ps_preset {project projects_folder scriptdir} {
   ...
   # Connect the SD card WP pin to MIO25 and pull it down to enable software (PetaLinux) 
   # to mount and write the SD card
   set_property -dict [list CONFIG.PSU__SD0__GRP_WP__ENABLE {1} CONFIG.PSU_MIO_25_PULLUPDOWN {pulldown}] [get_bd_cells zynq_ultra_ps_e_0]

...
proc avnet_add_user_io {project projects_folder scriptdir} {
   ...
   # add selection for proper xdc based on needs
   add_files -fileset constrs_1 -norecurse $scriptdir/../Boards/PZ7010_FMC2/PZ7010_FMC2_user_io.xdc
...
proc avnet_add_i2c {project projects_folder scriptdir} {
   ...
   # add selection for proper xdc based on needs
   add_files -fileset constrs_1 -norecurse $scriptdir/../Boards/PZ7010_FMC2/PZ7010_FMC2_i2c.xdc

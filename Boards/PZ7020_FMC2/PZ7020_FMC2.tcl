...
proc avnet_add_ali3_display_kit {project projects_folder scriptdir} {
   ...
   # add selection for proper xdc based on needs
   add_files -fileset constrs_1 -norecurse $scriptdir/../Boards/PZ7020_FMC2/PZ7020_FMC2_ali3_pmod.xdc
...
proc avnet_add_user_io {project projects_folder scriptdir} {
   ...
   # add selection for proper xdc based on needs
   add_files -fileset constrs_1 -norecurse $scriptdir/../Boards/PZ7020_FMC2/PZ7020_FMC2_user_io.xdc

...
proc avnet_assign_addresses {project projects_folder scriptdir} {
   ...
   # Assign axi_intc_0/S_AXI to address offset 0xA009_0000 and range of 64K
   assign_bd_address -offset 0xA009_0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force

   # Assign system_management_wiz_0/S_AXI_LITE to address offset 0xA008_0000 and range of 64K
   assign_bd_address -offset 0xA008_0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs system_management_wiz_0/S_AXI_LITE/Reg] -force

   # Assign axi_gpio_2/S_AXI to address offset 0xA005_0000 and range of 64K
   assign_bd_address -offset 0xA005_0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force

   # Assign axi_gpio_1/S_AXI to address offset 0xA004_0000 and range of 64K
   assign_bd_address -offset 0xA004_0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force

   # Assign GPIO/axi_gpio_0/S_AXI to address offset 0xA003_0000 and range of 64K
   assign_bd_address -offset 0xA003_0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs GPIO/axi_gpio_0/S_AXI/Reg] -force

   # Assign zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW to address offset 0x0000_0000 and range of 2G
   assign_bd_address -offset 0x0000_0000 -range 0x80000000 -target_address_space [get_bd_addr_segs /CAPTURE_PIPELINE/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force

   # Assign zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM to address offset 0xFF00_0000 and range of 16M
   assign_bd_address -offset 0xFF00_0000 -range 0x01000000 -target_address_space [get_bd_addr_segs /CAPTURE_PIPELINE/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
   
   # Assign zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW to address offset 0x0000_0000 and range of 2G
   assign_bd_address -offset 0x0000_0000 -range 0x80000000 -target_address_space [get_bd_addr_segs /DISPLAY_PIPELINE/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force

   # Assign zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM to address offset 0xFF00_0000 and range of 16M
   assign_bd_address -offset 0xFF00_0000 -range 0x01000000 -target_address_space [get_bd_addr_segs /DISPLAY_PIPELINE/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
...
proc create_hier_cell_CAPTURE_PIPELINE { parentCell nameHier } {
   ...
   connect_bd_intf_net [get_bd_intf_pins csi_mipi_phy_if] [get_bd_intf_pins mipi_csi2_rx_subsyst_0/mipi_phy_if]
   ...
   # Create port connections
   connect_bd_net [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
   connect_bd_net [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
   ...
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins axis_subset_converter_1/aclk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins mipi_csi2_rx_subsyst_0/dphy_clk_200M] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins proc_sys_reset_3/slowest_sync_clk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins v_frmbuf_wr_0/ap_clk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins v_proc_ss_csc_0/aclk] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins v_proc_ss_scaler_0/aclk_axis] 
   connect_bd_net [get_bd_pins dphy_clk_200M] [get_bd_pins v_proc_ss_scaler_0/aclk_ctrl]

   connect_bd_net [get_bd_pins dcm_locked] [get_bd_pins proc_sys_reset_1/dcm_locked] 
   connect_bd_net [get_bd_pins dcm_locked] [get_bd_pins proc_sys_reset_2/dcm_locked] 
   connect_bd_net [get_bd_pins dcm_locked] [get_bd_pins proc_sys_reset_3/dcm_locked]

   connect_bd_net [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] 
   connect_bd_net [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] 
   connect_bd_net [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in]
   ...
   connect_bd_net [get_bd_pins video_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn]
...
proc avnet_add_pl_dualcam {project projects_folder scriptdir} {
   ...
   # MIPI interface ports
   create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:mipi_phy_rtl:1.0 csi_mipi_phy_if
   ...
   # AXI interrconnect connections from CAPTURE_PIPELINE and DISPLAY_PIPELINE to the PS (mm video)
   ...
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins CAPTURE_PIPELINE/m_axi_mm_video] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins DISPLAY_PIPELINE/m_axi_mm_video] [get_bd_intf_pins axi_interconnect_1/S01_AXI]
   
   # AXI interrconnect connections from the PS to CAPTURE_PIPELINE and DISPLAY_PIPELINE (ctrl)
   connect_bd_intf_net [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD] -boundary_type upper [get_bd_intf_pins axi_interconnect_0/S00_AXI]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/csirxss_s_axi]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/scaler_ctrl]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/frmbuf_ctrl]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/csc_ctrl]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins DISPLAY_PIPELINE/dsi_tx_s_axi]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins DISPLAY_PIPELINE/v_frmbuf_rd_s_axi_CTRL]
   
   # AXI interrconnect connections for GPIO
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins GPIO/S_AXI]
   
   # MIPI interface connections
   connect_bd_intf_net [get_bd_intf_ports csi_mipi_phy_if] [get_bd_intf_pins CAPTURE_PIPELINE/csi_mipi_phy_if]
   ...
   connect_bd_net [get_bd_pins DISPLAY_PIPELINE/frame_buf_rd_int] [get_bd_pins xlconcat_0/In4]
   connect_bd_net [get_bd_pins DISPLAY_PIPELINE/dsi_tx_int] [get_bd_pins xlconcat_0/In5]
   
   # Clock connections for GPIO
   ...
   # Clock connections for CAPTURE_PIPELINE and DISPLAY_PIPELINE
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/S00_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M00_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M01_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M02_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M03_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M04_ACLK]
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_0/M05_ACLK]
   ...
   connect_bd_net [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins axi_interconnect_1/S01_ACLK]
   ...
   # Reset connections for CAPTURE_PIPELINE and DISPLAY_PIPELINE interconnect
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M01_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M03_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M04_ARESETN]
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M05_ARESETN]
   ...
   connect_bd_net [get_bd_pins proc_sys_reset_4/peripheral_aresetn] [get_bd_pins axi_interconnect_1/S01_ARESETN]
   ...
   # Resets port connections for GPIO
   ...
   # Reset connections for CAPTURE_PIPELINE and DISPLAY_PIPELINE IPs

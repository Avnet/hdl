...
proc avnet_add_vitis_directives {project projects_folder scriptdir} {
   ...
   set_property platform.description                   "Base UZ3EG_IOCC development platform" [current_project]
   ...
   # specific to Vitis 2019.2, no longer applicable for Vitis 2020.1
   #set_property platform.post_sys_link_tcl_hook        ${projects_folder}/../../../boards/uz3eg_iocc/uz3eg_iocc_dynamic_postlink.tcl [current_project]

...
proc avnet_add_user_io_preset {project projects_folder scriptdir} {
   ...
   # Pmod JY (only for MicroZed 7020)
   ...
   apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { \
      ...
      Clk_xbar {Auto} \
      Master {/ps7/M_AXI_GP0} \
      Slave {/axi_gpio_11/S_AXI} \
      ddr_seg {Auto} \
      intc_ip {/ps7_axi_periph} \
      master_apm {0}} [get_bd_intf_pins axi_gpio_11/S_AXI]
   ...
   set_property -dict [list \
      ...
      CONFIG.C_IS_DUAL {1} \
      CONFIG.C_ALL_INPUTS_2 {1} \
      CONFIG.C_ALL_OUTPUTS {1}] [get_bd_cells axi_gpio_11]

   make_bd_intf_pins_external  [get_bd_intf_pins axi_gpio_11/GPIO]
   make_bd_intf_pins_external  [get_bd_intf_pins axi_gpio_11/GPIO2]
   set_property name pmod_jy_out [get_bd_intf_ports GPIO_0]
   set_property name pmod_jy_in [get_bd_intf_ports GPIO2_0]
   save_bd_design

   # Pmod JZ (only for MicroZed 7020)
   ...
   apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { \
      ...
      Clk_xbar {Auto} \
      Master {/ps7/M_AXI_GP0} \
      Slave {/axi_gpio_12/S_AXI} \
      ddr_seg {Auto} \
      intc_ip {/ps7_axi_periph} \
      master_apm {0}} [get_bd_intf_pins axi_gpio_12/S_AXI]
   ...
   set_property -dict [list \
      ...
      CONFIG.C_IS_DUAL {1} \
      CONFIG.C_ALL_INPUTS_2 {1} \
      CONFIG.C_ALL_OUTPUTS {1}] [get_bd_cells axi_gpio_12]

   make_bd_intf_pins_external  [get_bd_intf_pins axi_gpio_12/GPIO]
   make_bd_intf_pins_external  [get_bd_intf_pins axi_gpio_12/GPIO2]
   set_property name pmod_jz_out [get_bd_intf_ports GPIO_0]
   set_property name pmod_jz_in [get_bd_intf_ports GPIO2_0]
...
proc avnet_assign_addresses {project projects_folder scriptdir} {
   ...
   # pmod_jy
   assign_bd_address -offset 0x412B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_gpio_11/S_AXI/Reg] -force
   # pmod_jz
   assign_bd_address -offset 0x412C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_gpio_12/S_AXI/Reg] -force

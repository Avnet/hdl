...
proc avnet_add_pl_dualcam {project projects_folder scriptdir} {
   ...
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/s_axi_ctrl]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_1/M02_AXI] [get_bd_intf_pins CAPTURE_PIPELINE/s_axi_CTRL1]
   connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_1/M03_AXI] [get_bd_intf_pins DISPLAY_PIPELINE/v_frmbuf_rd_s_axi_CTRL]
   ...
   connect_bd_net [get_bd_pins GPIO/frame_buffer_wr_resetn] [get_bd_pins CAPTURE_PIPELINE/aux_reset_in] 

...
proc avnet_create_project {project projects_folder scriptdir} {
   ...
   create_project $project $projects_folder -part xc7z030sbg485-1-i -force
}
...
proc avnet_add_vitis_directives {project projects_folder scriptdir} {
   ...
   #set_property platform.post_sys_link_tcl_hook        ${projects_folder}/../../../boards/pz7030_fmc2/pz7030_fmc2_dynamic_postlink.tcl [current_project]
   #set_property platform.post_sys_link_overlay_tcl_hook        ${projects_folder}/../../../boards/pz7030_fmc2/pz7030_fmc2_dynamic_postlink.tcl [current_project]

...
#  Module Name:         uz7ev_evcc_hdmi_v.tcl
...
proc avnet_add_user_io_preset {project projects_folder scriptdir} {
   ...
   # LEDs disabled as axi gpio, used for hdmi
...
proc avnet_add_hdmi {project projects_folder scriptdir} {
  ...
  connect_bd_intf_net [get_bd_intf_pins vid_phy_controller_0/vid_phy_axi4lite] -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  ...
  connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins vid_phy_controller_0/vid_phy_sb_aclk]
  ...
  connect_bd_net [get_bd_pins vid_phy_controller_0/vid_phy_axi4lite_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  connect_bd_net [get_bd_pins axi_intc_1/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net [get_bd_pins axi_intc_1/s_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  connect_bd_net [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins ps8_0_axi_periph/M06_AXI] [get_bd_intf_pins hdmi_tx/S_AXI_CPU_IN]
  ...
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins hdmi_tx/s_axi_CTRL]
  connect_bd_net [get_bd_pins hdmi_tx/ap_clk] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net [get_bd_pins xlslice_1/Dout] [get_bd_pins hdmi_rx/aresetn_ctrl]

  connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins hdmi_tx/s_axis_audio_aclk]
  ...
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_1/S02_AXI] [get_bd_intf_pins hdmi_tx/m_axi_mm_video3]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_1/S03_AXI] [get_bd_intf_pins hdmi_tx/m_axi_mm_video4]
  ...
  connect_bd_net [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net [get_bd_pins axi_interconnect_1/S02_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net [get_bd_pins axi_interconnect_1/S03_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net [get_bd_pins axi_interconnect_1/S04_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net [get_bd_pins axi_interconnect_1/S02_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net [get_bd_pins axi_interconnect_1/S03_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net [get_bd_pins axi_interconnect_1/S04_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins hdmi_rx/S_AXI_CPU_IN] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_net [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]

  connect_bd_net [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins hdmi_rx/s_axi_CTRL1]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins hdmi_rx/s_axi_ctrl]

  connect_bd_net [get_bd_ports RX_DET_IN] [get_bd_pins hdmi_rx/RX_DET_IN]
  connect_bd_net [get_bd_pins hdmi_rx/aclk_axis] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
...
# This will add AXI interconnect and xdma block, etc. to support using NVME SSD
...
proc avnet_add_pcie {project projects_folder scriptdir} {
  ...
  # Set number of AXI interconnect master ports to 5 (add 2 ports for xdma block connections)
  set_property -dict [list CONFIG.NUM_MI {5}] [get_bd_cells axi_interconnect_0]

  # Enable S_AXI_HP1_FPD port on ZynqMP PS
  ...
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_mem_intercon_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins xdma_0/S_AXI_B]
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins xdma_0/S_AXI_LITE]
  ...
  connect_bd_net [get_bd_pins xdma_0/axi_ctl_aresetn] [get_bd_pins axi_interconnect_0/M04_ARESETN]
  ...
  connect_bd_net [get_bd_pins xdma_0/interrupt_out] [get_bd_pins xlconcat_0/In3]
  connect_bd_net [get_bd_pins xdma_0/interrupt_out_msi_vec0to31] [get_bd_pins xlconcat_0/In4]
  connect_bd_net [get_bd_pins xdma_0/interrupt_out_msi_vec32to63] [get_bd_pins xlconcat_0/In6]
...
proc avnet_assign_addresses {project projects_folder scriptdir} {
  ...
  assign_bd_address -offset 0xB1000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xdma_0/S_AXI_B/BAR0] -force
...
proc avnet_add_vitis_directives {project projects_folder scriptdir} {
   ...
   set_property platform.description                   "UZ7EV_EVCC_HDMI_V_N development platform" [current_project]

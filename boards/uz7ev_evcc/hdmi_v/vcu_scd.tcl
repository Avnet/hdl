...
proc create_hier_cell_vcu { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 scd_m_axi_mm_video

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 scd_s_axi_CTRL
  ...
  create_bd_pin -dir I -type rst scd_ap_rst_n
  create_bd_pin -dir O -type intr scd_interrupt
  ...
  connect_bd_intf_net -intf_net S09_AXI_1 [get_bd_intf_pins scd_m_axi_mm_video] [get_bd_intf_pins v_scenechange_0/m_axi_mm_video]
  ...
  connect_bd_intf_net -intf_net mpsoc_ss_scn_chg_ctrl [get_bd_intf_pins scd_s_axi_CTRL] [get_bd_intf_pins v_scenechange_0/s_axi_CTRL]
  ...
  connect_bd_net -net scd_ap_rst_n_1 [get_bd_pins scd_ap_rst_n] [get_bd_pins v_scenechange_0/ap_rst_n]
  connect_bd_net -net v_scenechange_0_interrupt [get_bd_pins scd_interrupt] [get_bd_pins v_scenechange_0/interrupt]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_vcu parentCell nameHier"
   puts "#"
   puts "##################################################################"
}

...
#  Design Name:         ZUBoard-1CG Trifecta HSIO HW Platform
#  Module Name:         zub1cg_sbc_trifecta.tcl
...
proc avnet_add_ps_preset {project projects_folder scriptdir} {
   ...
   # Enable DisplayPort using PS GTR2 and GTR3
   set_property -dict [list \
...
proc avnet_assign_addresses {project projects_folder scriptdir} {
   ...
   assign_bd_address -target_address_space /CAPTURE_PIPELINE/v_frmbuf_wr_0/Data_m_axi_mm_video [get_bd_addr_segs /zynq_ultra_ps_e_0/SAXIGP2/HP0_PCIE_LOW] -force
   #Slave segment '/zynq_ultra_ps_e_0/SAXIGP2/HP0_PCIE_LOW' is being assigned into address space '/CAPTURE_PIPELINE/v_frmbuf_wr_0/Data_m_axi_mm_video' at <0xE000_0000 [ 256M ]>.
...
proc create_hier_cell_CAPTURE_PIPELINE { parentCell nameHier } {
   ...
   create_bd_cell -type ip -vlnv xilinx.com:ip:v_frmbuf_wr:3.0 v_frmbuf_wr_0
   set_property -dict [ list \
...
proc create_hier_cell_DISPLAY_PIPELINE { parentCell nameHier } {
   ...
   create_bd_cell -type ip -vlnv xilinx.com:ip:v_frmbuf_rd:3.0 v_frmbuf_rd_0
   set_property -dict [list \
      CONFIG.HAS_RGB8 {0} \
      CONFIG.HAS_RGBX8 {0} \
      CONFIG.HAS_YUYV8 {1} \

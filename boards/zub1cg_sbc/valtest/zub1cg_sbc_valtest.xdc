...
place_ports push_button_1bit A8
set_property IOSTANDARD LVCMOS18 [get_ports [list push_button_1bit]]
...
set_property PACKAGE_PIN A8 [get_ports push_button_1bit ]; # HD_GPIO_PB1 

set_property PACKAGE_PIN A7 [get_ports {rgb_led_0[0]}]; # HD_GPIO_RGB1_R 
set_property PACKAGE_PIN B6 [get_ports {rgb_led_0[1]}]; # HD_GPIO_RGB1_G 
set_property PACKAGE_PIN B5 [get_ports {rgb_led_0[2]}]; # HD_GPIO_RGB1_B 

set_property PACKAGE_PIN B4 [get_ports {rgb_led_1[0]}]; # HP_GPIO_RGB2_R 
set_property PACKAGE_PIN A2 [get_ports {rgb_led_1[1]}]; # HP_GPIO_RGB2_G 
set_property PACKAGE_PIN F4 [get_ports {rgb_led_1[2]}]; # HP_GPIO_RGB2_B 

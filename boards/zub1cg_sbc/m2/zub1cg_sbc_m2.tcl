...
#  Module Name:         zub1cg_sbc_m2.tcl
#  Project Name:        ZUBoard-1CG M.2
...
proc avnet_add_ps_preset {project projects_folder scriptdir} {
   ...
   # Enable the SD0 and set it to SDIO 2.0 4-bit mode
   set_property -dict [list \
      CONFIG.PSU__SD0__GRP_POW__ENABLE {0} \
      CONFIG.PSU__SD0__PERIPHERAL__ENABLE {1} \
      CONFIG.PSU__SD0__PERIPHERAL__IO {MIO 13 .. 16 21 22} \
      CONFIG.PSU__SD0__SLOT_TYPE {SD 2.0} ] [get_bd_cells zynq_ultra_ps_e_0]

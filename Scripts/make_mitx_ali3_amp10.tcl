...
set argv [list board=MITXZ7045 project=mitx_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

# Build Zed Display Kit reference design
# for Zynq Z7100 Mini-ITX
set argv [list board=MITXZ7100 project=mitx_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

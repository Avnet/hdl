...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_GPIO2_WIDTH {8} CONFIG.C_GPIO_WIDTH {8} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {Custom} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true} ] $axi_gpio_3
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_GPIO2_WIDTH {18} CONFIG.C_GPIO_WIDTH {18} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {Custom} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true} ] $axi_gpio_4
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_GPIO2_WIDTH {18} CONFIG.C_GPIO_WIDTH {18} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {Custom} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true} ] $axi_gpio_5
  ...
  set_property -dict [ list CONFIG.NUM_MI {7}  ] $zynq_ultra_ps_e_0_axi_periph
  ...
  connect_bd_intf_net [get_bd_intf_ports input_from_pmods] [get_bd_intf_pins axi_gpio_3/GPIO]
  connect_bd_intf_net [get_bd_intf_ports output_to_pmods] [get_bd_intf_pins axi_gpio_3/GPIO2]
  connect_bd_intf_net [get_bd_intf_ports fmc_lpc_se_high_ch1] [get_bd_intf_pins axi_gpio_4/GPIO]
  connect_bd_intf_net [get_bd_intf_ports fmc_lpc_se_high_ch2] [get_bd_intf_pins axi_gpio_4/GPIO2]
  connect_bd_intf_net [get_bd_intf_ports fmc_lpc_se_low_ch1] [get_bd_intf_pins axi_gpio_5/GPIO]
  connect_bd_intf_net [get_bd_intf_ports fmc_lpc_se_low_ch2] [get_bd_intf_pins axi_gpio_5/GPIO2]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M06_AXI [get_bd_intf_pins system_management_wiz_0/S_AXI_LITE] [get_bd_intf_pins zynq_ultra_ps_e_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M00_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M01_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M02_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M03_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M04_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M05_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/M06_ARESETN] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/S00_ARESETN] [get_bd_pins rst_zynq_ultra_ps_e_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x0080060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs system_management_wiz_0/S_AXI_LITE/Reg] SEG_system_management_wiz_0_Reg

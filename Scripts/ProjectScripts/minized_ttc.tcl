...
# -------------------------------------------------------------------------------------------------------------------------------------------
 ...
 CONFIG.C_EXTERNAL_XIN_CLK_HZ {48000000}
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_w_Int_0/s00_axi/reg0] SEG_PWM_w_Int_0_S00_AXI_reg
...
add_files -fileset constrs_1 -norecurse ${projects_folder}/../minized_ttc.xdc

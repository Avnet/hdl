...
set files [list \
 ...
 "[file normalize "../../IP/minized/hdl/vhdl/sdcard_mgr.vhd"]"\
 "[file normalize "../../IP/minized/hdl/vhdl/pmod2_mgr.vhd"]"\
...
avnet_generate_RTL_ip sdcard_mgr sdcard_mgr_0
avnet_generate_RTL_ip pmod2_mgr pmod2_mgr_0

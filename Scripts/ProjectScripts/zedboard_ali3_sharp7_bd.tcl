...
proc create_hier_cell_zed_ali3_display { parentCell nameHier } {
  ...
  set vtiming_gen_0 [ create_bd_cell -type ip -vlnv avnet:avnet_display:vtiming_gen:1.3 vtiming_gen_0 ]
  ...
  set zed_ali3_controller_0 [ create_bd_cell -type ip -vlnv avnet:avnet_display:zed_ali3_controller:1.1 zed_ali3_controller_0 ]
  ...
  connect_bd_net -net ali3_clk_in_1 [get_bd_pins ali3_clk_in] [get_bd_pins zed_ali3_controller_0/clk_in]
  connect_bd_net -net ali3_i2c_irq_1 [get_bd_pins ali3_iic_irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net ali3_t_irq_1 [get_bd_pins ali3_touch_irq] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_root_design { parentCell } {
  ...
  # Rather than use the built in ZedBoard presets, use the PS7 settings from 
...
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {.029} \

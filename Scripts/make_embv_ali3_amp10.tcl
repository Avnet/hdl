...
#
#  Revision:            Nov 02, 2015: 1.00 Initial version
# 
# ----------------------------------------------------------------------------

# Build Zed Display Kit reference design
# for MicroZed EMBV Carrier + MicroZed 7010 SOM
set argv [list board=MZ7010_EMBV project=embv_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

# Build Zed Display Kit reference design
# for MicroZed EMBV Carrier + MicroZed 7020 SOM
set argv [list board=MZ7020_EMBV project=embv_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

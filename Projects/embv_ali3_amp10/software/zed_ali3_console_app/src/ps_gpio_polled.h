...
//                      Jun  4, 2015: 1.02 Revised for MicroZed EMBV target
//
//----------------------------------------------------------------------------
...
#define PS_GPIO_USER_LED0              (13)
#define PS_GPIO_USER_LED1              (11)
#define PS_GPIO_USER_BUTTON0           (10)
#define PS_GPIO_USER_BUTTON1           (12)
#define PS_GPIO_USER_LED_START         ((PS_GPIO_EMIO_START) + 0)
#define PS_GPIO_USER_BUTTON_START      ((PS_GPIO_EMIO_START) + 4)

...
void avnet_console_banner_command(avnet_console_t *pConsole)
{
    ...
    pConsole->io_hprintf( pConsole->io_handle, "|                                                      .++++++++.            |\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "| oddddNNN                dNN  dNNdddms-                                 dNN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "|     -mh:                 NN   NN   oNN                                  NN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "|    hNo    `/yyyyo   :yyyyNN   NNyyyNh/  `/yyyy:   /yyyyyy  yyy`-yy -yyyyNN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "|  :hd+     dNooooNy hN:--sNN   NN---:Nd/ dN---:Ny hN---yNN  -NNdy+-yNy---NN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "| /Ny.``dd- NNs--/s+ mN:  /NN   NN```:NNh NN:  /Ny NN.  /NN`  NN.   dN/  .NN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "|oNNmmmmNN- `oNddmo/ `omddmNN   NNmmmNs+  `odddd+  `omdddNNm  mN    `/hddmhN+|\n\r");
    pConsole->io_hprintf( pConsole->io_handle, "------------------------------------------------------------------------------\n\r");

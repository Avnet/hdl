...
#include "zed_pb_red_off.h"
#include "zed_pb_red_on.h"
...
int zed_ali3_controller_demo_board_process(zed_ali3_controller_demo_t *pDemo)
{
    ...
    if (pDemo->mode == control)
    {
        ...
        if ((pDemo->button0_state == 0) && (ps_gpio_get_button(pDemo, 0) == 1))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered ON event on button N control.\n\r");
            }
        }
        else if ((pDemo->button0_state == 1) && (ps_gpio_get_button(pDemo, 0) == 0))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered OFF event on button N control.\n\r");
            }
        }

        // Check board input on button S
        if ((pDemo->button1_state == 0) && (ps_gpio_get_button(pDemo, 1) == 1))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered ON event on button S control.\n\r");
            }
        }
        else if ((pDemo->button1_state == 1) && (ps_gpio_get_button(pDemo, 1) == 0))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered OFF event on button S control.\n\r");
            }
        }
		
        // Check board input on button E
        if ((pDemo->button2_state == 0) && (ps_gpio_get_button(pDemo, 2) == 1))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered ON event on button E control.\n\r");
            }
        }
        else if ((pDemo->button2_state == 1) && (ps_gpio_get_button(pDemo, 2) == 0))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered OFF event on button E control.\n\r");
            }
        }
		
        // Check board input on button W
        if ((pDemo->button3_state == 0) && (ps_gpio_get_button(pDemo, 3) == 1))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered ON event on button W control.\n\r");
            }
        }
        else if ((pDemo->button3_state == 1) && (ps_gpio_get_button(pDemo, 3) == 0))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered OFF event on button W control.\n\r");
            }
        }
        // Check board input on button C
        if ((pDemo->button4_state == 0) && (ps_gpio_get_button(pDemo, 4) == 1))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered ON event on button C control.\n\r");
            }
        }
        else if ((pDemo->button4_state == 1) && (ps_gpio_get_button(pDemo, 4) == 0))
        {
            ...
            if (pDemo->bVerbose)
            {
                xil_printf("Registered OFF event on button C control.\n\r");
            }
        }
...
int zed_ali3_controller_demo_button(zed_ali3_controller_demo_t *pDemo, int button_number, int button_state)
{
    ...
    if (button_state == 0)
    {
        ...
        graphic.default_image_data = avnet_control_pb_red_off;
        graphic.alternate_image_data = avnet_control_pb_red_on;

        // All the switch images have the same OFF width.
        graphic.size_x = avnet_control_pb_red_off_width;
        graphic.size_y = avnet_control_pb_red_off_height;
    }
    else if (button_state == 1)
    {
        // Draw the switch on state.
        graphic.default_image_data = avnet_control_pb_red_on;
        graphic.alternate_image_data = avnet_control_pb_red_off;

        // All the switch images have the same ON width.
        graphic.size_x = avnet_control_pb_red_on_width;
        graphic.size_y = avnet_control_pb_red_on_height;
    }
    else
    {
        return -1;

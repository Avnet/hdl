...
void pca9534_set_pins_direction(fmc_iic_t *pInstance, u8 direction) {
	...
	pInstance->fpIicWrite( pInstance, IIC_PCA9534_SADR, PCA9534_CONFIG_REG, &status, 1);
}
...
void pca9534_set_pin_direction(fmc_iic_t *pInstance, u8 pinno, u8 direction) {
	...
	pInstance->fpIicRead( pInstance, IIC_PCA9534_SADR, PCA9534_CONFIG_REG, &status, 1);
...
void pca9534_set_pin_value(fmc_iic_t *pInstance, u8 pinno, u8 value) {
	...
	pInstance->fpIicRead( pInstance, IIC_PCA9534_SADR, PCA9534_OUTPUT_REG, &status, 1);
	...
	pInstance->fpIicWrite( pInstance, IIC_PCA9534_SADR, PCA9534_OUTPUT_REG, &status, 1);
}
...
int pca9534_get_pin_value(fmc_iic_t *pInstance, u8 pinno) {
	...
	pInstance->fpIicRead( pInstance, IIC_PCA9534_SADR, PCA9534_INPUT_REG, &status, 1);

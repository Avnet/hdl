...
/*****************************************************************************
******************************************************************************/
int     ReadSetup(XAxiVdma *InstancePtr, u32 BaseAddr, u32 PixelByte, u32 PointNum,
          ...
          u32 HoriSize, u32 VertSize, u32 HoriStride, u32 VertStride)
{
  ...
  ReadCfg.HoriSizeInput = HoriSize * PixelByte;           // Convert Pixels to Bytes

  ReadCfg.Stride = HoriStride * PixelByte;                // Convert Pixels to Bytes
  ...
  BlockOffset = (HoriStride * PixelByte) * VertOffset;
  BlockOffset += (HoriOffset * PixelByte);
  ...
  for(Index = 0; Index < 3; Index++) {
    ...
    BaseAddr += HoriStride * PixelByte * VertStride;
  }
...
/*****************************************************************************
******************************************************************************/
int     WriteSetup(XAxiVdma * InstancePtr, u32 BaseAddr, u32 PixelByte, u32 PointNum,
          u32 EnableCircularBuf, u32 EnableSync, u32 HoriOffset, u32 VertOffset,
          u32 HoriSize, u32 VertSize, u32 HoriStride, u32 VertStride)
{
  int Index;
  ...
  WriteCfg.HoriSizeInput = HoriSize * PixelByte;

  WriteCfg.Stride = HoriStride * PixelByte;

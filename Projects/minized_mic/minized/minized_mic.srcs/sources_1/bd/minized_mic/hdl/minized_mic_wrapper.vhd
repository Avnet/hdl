...
end minized_mic_wrapper;

architecture STRUCTURE of minized_mic_wrapper is
  component minized_mic is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component minized_mic;
begin
minized_mic_i: component minized_mic
     port map (
      AUDIO_CLK => AUDIO_CLK,
      AUDIO_DAT => AUDIO_DAT,

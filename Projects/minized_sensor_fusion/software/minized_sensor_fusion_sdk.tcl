...
# 
#  Description:         SDK Build Script for MiniZed Sensor Fusion hardware 
#                       platform
# 
#  Dependencies:        To be called from a configured make script call
#
#  Revision:            Jul 20, 2017: 1.00 Initial version
# 
# ----------------------------------------------------------------------------

#!/usr/bin/tclsh
set project  "minized_sensor_fusion"
set hw_name  "minized_sensor_fusion_hw"
set bsp_name "minized_sensor_fusion_bsp"

...
// Design Name:         ALI3 Display Controller Demonstration
// Module Name:         zed_ali3_controller_demo.c
// Project Name:        Zed ALI3 Display Kit
...
//						Oct 28, 2015: 1.03 Updated to support Ampire 10"
...
{
    /*
     * Check to see touch calibration is required.
     */
    if (pDemo->calibration_success == 0)
    {

...
//#if 1
  ...
  pConsole->command_process_func(pConsole->user_struct, cargc, cargv);
  pConsole->io_hprintf( pConsole->io_handle, "\n\r%s>", AVNET_CONSOLE_PROMPT );
...
//  {
//	  avnet_console_iic_command( pConsole, cargc, cargv, pdemo->piicps0 );
//  }
//  else if ( !strcmp(cargv[0],"fps") )
//  {
//	  avnet_console_fps_command( pConsole, cargc, cargv, pdemo->piicps0 );
//  }
...
//				}
//
//				XIicPs_A16_Read(pIIC,  (device >> 1), address, &data,
//						1);
//
//				pConsole->io_hprintf(pConsole->io_handle,

...
void avnet_console_banner_command(avnet_console_t *pConsole)
{
    pConsole->io_hprintf(pConsole->io_handle, "\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "------------------------------------------------------------------------------\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                       ;2HBA3i;          ;r:                                |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                    rH@@2;;::;r5h93XSr,  G@@@S                              |\n\r");




    pConsole->io_hprintf(pConsole->io_handle, "|                 .9@@2:;S3hH@@@@@@@@@@@#i  r@@@r                            |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                3@#:.r2AH#@@AAAAAAAAHM@@@#r  X@@h                           |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|              ;@@; sHr    i@@##B&&&&H#@@@@@&  r@@X                          |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|            .9@X ,#@;          s#BM@X.   ,A@M  s@@r                         |\n\r");




    pConsole->io_hprintf(pConsole->io_handle, "|            A@i ;@@@s     SG,              r@5  @@9.                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|           A@2 i@MAB@#:,i@@@@@@@#r         r@@  A@M:                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|           r; r#@AAB@@@@@@@@M;rr         r@@@@  &@#;                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|              @@AAM@5 .#@@      2h&AAAHAM@@M#h  #@A,                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|             ,@@AH3      .  .#@@@@@@@@@@@#A@M, ,@@i                         |\n\r");


    pConsole->io_hprintf(pConsole->io_handle, "|             .@@#i      .BG@@@@@@##@@@Xs2@@@2 .H@@,                         |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|              @@##2         ,..S@@@ii,   ,@2  B@@s                          |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|          r@r ;@@@@@r  i@HG25;            22 i@@3                           |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|          h@@  r@@@@@@@@@@@@@@@@i          rH                               |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|          :@@@  .@@@@@@@#####@@@@@         #@                               |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|           ;@@@;  ,H@@@@@##@@@@@@@@;     9@@s                               |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|            ,@@@@:    ;2A####AXr. ;#@@@@@@@;                                |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|              i@@@@H:            :: ,h#MS.                                  |\n\r");


    pConsole->io_hprintf(pConsole->io_handle, "|                ;&@@@@@@#HAAB@@@@@@s                                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                  .:rs2hAHBBH&35s;:.                                        |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                                             ,:,,.,.              .::       |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                 .                          ,@@@@@@@r             ,@@h,     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|                ;@B,                         .,..@@@.               @#,     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|       ;,     :  i;   ;SS;  .ir. :s, ,sSir      r#r   .;ri5;    ,r;:@A,     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|      :@@X  ,@@2:@H .B@#@@@r,@@@@@@9B@@M@@@r  .#@r    M@@sM@@. A@@@@@3,     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|      .@@@@@@@@;.@G 3@:  .r, .@@S: ;@&   s@@ 2@@.    :@@HiX@@Si@:   @H:     |\n\r");
    ...
    pConsole->io_hprintf(pConsole->io_handle, "|      ,@# @@A @s @A s@5  ,@G ,@&   :@@i  @@M;@@i  A@5.A@r ,SX s@2  :@M:     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "|      ,#2     @2.@#  A@@@@@i ,@@     H@@@#. #@@@@@@@i  h@@@@h  #@@@@@2:     |\n\r");
    pConsole->io_hprintf(pConsole->io_handle, "------------------------------------------------------------------------------\n\r");

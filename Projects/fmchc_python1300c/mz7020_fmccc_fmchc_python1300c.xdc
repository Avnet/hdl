...
set_property PACKAGE_PIN N18 [get_ports IO_PYTHON_CAM_clk_out_p]
set_property PACKAGE_PIN P19 [get_ports IO_PYTHON_CAM_clk_out_n]
set_property PACKAGE_PIN Y18 [get_ports IO_PYTHON_CAM_sync_p]
set_property PACKAGE_PIN Y19 [get_ports IO_PYTHON_CAM_sync_n]
#set_property PACKAGE_PIN V20 [get_ports {IO_PYTHON_CAM_data_p[7]}]
#set_property PACKAGE_PIN W20 [get_ports {IO_PYTHON_CAM_data_n[7]}]
#set_property PACKAGE_PIN U14 [get_ports {IO_PYTHON_CAM_data_p[6]}]
#set_property PACKAGE_PIN U15 [get_ports {IO_PYTHON_CAM_data_n[6]}]
#set_property PACKAGE_PIN T20 [get_ports {IO_PYTHON_CAM_data_p[5]}]
#set_property PACKAGE_PIN U20 [get_ports {IO_PYTHON_CAM_data_n[5]}]
#set_property PACKAGE_PIN T16 [get_ports {IO_PYTHON_CAM_data_p[4]}]
#set_property PACKAGE_PIN U17 [get_ports {IO_PYTHON_CAM_data_n[4]}]
set_property PACKAGE_PIN W14 [get_ports {IO_PYTHON_CAM_data_p[3]}];
set_property PACKAGE_PIN Y14 [get_ports {IO_PYTHON_CAM_data_n[3]}];
set_property PACKAGE_PIN V15 [get_ports {IO_PYTHON_CAM_data_p[2]}];
set_property PACKAGE_PIN W15 [get_ports {IO_PYTHON_CAM_data_n[2]}];
set_property PACKAGE_PIN Y16 [get_ports {IO_PYTHON_CAM_data_p[1]}];
set_property PACKAGE_PIN Y17 [get_ports {IO_PYTHON_CAM_data_n[1]}];
set_property PACKAGE_PIN P14 [get_ports {IO_PYTHON_CAM_data_p[0]}];
set_property PACKAGE_PIN R14 [get_ports {IO_PYTHON_CAM_data_n[0]}];

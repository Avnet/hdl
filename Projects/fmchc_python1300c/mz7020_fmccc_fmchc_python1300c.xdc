...
#set_property PACKAGE_PIN V20 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN W20 [get_ports {IO_PYTHON_CAM_data_n[]}]
set_property PACKAGE_PIN U14 [get_ports {IO_PYTHON_CAM_data_p[3]}]
set_property PACKAGE_PIN U15 [get_ports {IO_PYTHON_CAM_data_n[3]}]
#set_property PACKAGE_PIN T20 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN U20 [get_ports {IO_PYTHON_CAM_data_n[]}]
set_property PACKAGE_PIN T16 [get_ports {IO_PYTHON_CAM_data_p[2]}]
set_property PACKAGE_PIN U17 [get_ports {IO_PYTHON_CAM_data_n[2]}]
set_property PACKAGE_PIN W14 [get_ports {IO_PYTHON_CAM_data_p[1]}]
set_property PACKAGE_PIN Y14 [get_ports {IO_PYTHON_CAM_data_n[1]}]
set_property PACKAGE_PIN V15 [get_ports {IO_PYTHON_CAM_data_p[0]}]
set_property PACKAGE_PIN W15 [get_ports {IO_PYTHON_CAM_data_n[0]}]
#set_property PACKAGE_PIN Y16 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN Y17 [get_ports {IO_PYTHON_CAM_data_n[]}]
#set_property PACKAGE_PIN P14 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN R14 [get_ports {IO_PYTHON_CAM_data_n[]}]

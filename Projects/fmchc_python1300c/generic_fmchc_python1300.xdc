...
#set_property PACKAGE_PIN FMC{LA09_P} [get_ports {IO_PYTHON_CAM_data_p[7]}]
#set_property PACKAGE_PIN FMC{LA09_N} [get_ports {IO_PYTHON_CAM_data_n[7]}]
#set_property PACKAGE_PIN FMC{LA07_P} [get_ports {IO_PYTHON_CAM_data_p[6]}]
#set_property PACKAGE_PIN FMC{LA07_N} [get_ports {IO_PYTHON_CAM_data_n[6]}]
#set_property PACKAGE_PIN FMC{LA08_P} [get_ports {IO_PYTHON_CAM_data_p[5]}]
#set_property PACKAGE_PIN FMC{LA08_N} [get_ports {IO_PYTHON_CAM_data_n[5]}]
#set_property PACKAGE_PIN FMC{LA05_P} [get_ports {IO_PYTHON_CAM_data_p[4]}]
#set_property PACKAGE_PIN FMC{LA05_N} [get_ports {IO_PYTHON_CAM_data_n[4]}]
set_property PACKAGE_PIN FMC{LA04_P} [get_ports {IO_PYTHON_CAM_data_p[3]}];
set_property PACKAGE_PIN FMC{LA04_N} [get_ports {IO_PYTHON_CAM_data_n[3]}];
set_property PACKAGE_PIN FMC{LA06_P} [get_ports {IO_PYTHON_CAM_data_p[2]}];
set_property PACKAGE_PIN FMC{LA06_N} [get_ports {IO_PYTHON_CAM_data_n[2]}];
set_property PACKAGE_PIN FMC{LA03_P} [get_ports {IO_PYTHON_CAM_data_p[1]}];
set_property PACKAGE_PIN FMC{LA03_N} [get_ports {IO_PYTHON_CAM_data_n[1]}];
set_property PACKAGE_PIN FMC{LA02_P} [get_ports {IO_PYTHON_CAM_data_p[0]}];
set_property PACKAGE_PIN FMC{LA02_N} [get_ports {IO_PYTHON_CAM_data_n[0]}];

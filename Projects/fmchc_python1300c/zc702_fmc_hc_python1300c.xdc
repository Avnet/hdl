...
#set_property PACKAGE_PIN U16 [get_ports {IO_PYTHON_CAM_data_n[]}]
set_property PACKAGE_PIN U21 [get_ports {IO_PYTHON_CAM_data_n[3]}]
#set_property PACKAGE_PIN AB17 [get_ports {IO_PYTHON_CAM_data_n[]}]
set_property PACKAGE_PIN AB20 [get_ports {IO_PYTHON_CAM_data_n[2]}]
set_property PACKAGE_PIN V13 [get_ports {IO_PYTHON_CAM_data_p[1]}]
set_property PACKAGE_PIN W13 [get_ports {IO_PYTHON_CAM_data_n[1]}]
set_property PACKAGE_PIN U17 [get_ports {IO_PYTHON_CAM_data_p[0]}]
set_property PACKAGE_PIN V17 [get_ports {IO_PYTHON_CAM_data_n[0]}]
#set_property PACKAGE_PIN AA16 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN AB16 [get_ports {IO_PYTHON_CAM_data_n[]}]
#set_property PACKAGE_PIN V14 [get_ports {IO_PYTHON_CAM_data_p[]}]
#set_property PACKAGE_PIN V15 [get_ports {IO_PYTHON_CAM_data_n[]}]

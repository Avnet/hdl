...
# ----------------------------------------------------------------------------
#
#  Create Date:         May 20, 2024
#  Design Name:         K24 IOCC Base HW Platform
#  Module Name:         make_k24_iocc_base.tcl

...
#TC   avnet_add_user_io_preset $project $projects_folder $scriptdir
   ...
   avnet_add_fmc_quad $board $projects_folder $scriptdir

   avnet_add_comments $board $projects_folder $scriptdir
   ...
   import_files -fileset constrs_1 -norecurse ../boards/${board}/hdmi_quad/hdmi.xdc
   import_files -fileset constrs_1 -norecurse ../boards/${board}/hdmi_quad/fmc_quad.xdc

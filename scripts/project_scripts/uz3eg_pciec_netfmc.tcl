...
if {[string match -nocase "yes" $clean]} {
   ...
   set_property board_part avnet.com:ultrazed_eg_pciecc_production:part0:1.3 [current_project]
   ...
   # Add logic for Networking FMC support.
   puts ""
   puts "***** Adding defined IP blocks to block design..."
   avnet_add_netfmc ${board}_${project} $projects_folder $scriptdir

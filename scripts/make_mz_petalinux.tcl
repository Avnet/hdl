...
if {$argc != 0} {
   ...
   set argv [list board=mz7010_som project=mz_petalinux sdk=no version_override=yes]
   set argc [llength $argv]
   source ./make.tcl -notrace
   
   # Build PetaLinux BSP HW Platform
   # for MicroZed 7020 SOM
   set argv [list board=mz7020_som project=mz_petalinux sdk=no version_override=yes]
   set argc [llength $argv]
   source ./make.tcl -notrace
}

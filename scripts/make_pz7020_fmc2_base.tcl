...
#  Module Name:         make_pz7020_fmc2_base.tcl
...
if {$argc != 0} {
   ...
   ## Build PetaLinux BSP HW Platform
   ## for PicoZed 7020 SOM with FMC2 carrier
   set argv [list board=pz7020_fmc2 project=base sdk=no close_project=yes version_override=yes]
   set argc [llength $argv]
   source ./make.tcl -notrace
}

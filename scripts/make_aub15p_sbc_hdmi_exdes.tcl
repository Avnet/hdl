...
#  Module Name:         make_aub15p_sbc_hdmi.tcl
#  Project Name:        AUBoard-15P HDMI HW
...
if {$argc != 0} {
	...
	# Build valtest hw platform
   set argv [list board=aub15p_sbc project=hdmi_exdes sdk=no close_project=yes dev_arch=auplus]
   set argc [llength $argv]
   source ./make.tcl -notrace
}
